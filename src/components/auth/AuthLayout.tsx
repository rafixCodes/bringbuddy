...
interface AuthLayoutProps {
  children: ReactNode
  panel?: 'login' | 'register' | 'onboarding'
}
...
export function AuthLayout({ children, panel = 'login' }: AuthLayoutProps) {
    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[520px] shrink-0 flex-col relative overflow-hidden"
        ...
        <div className="relative z-10 flex items-center justify-between px-10 pt-8">
          <button onClick={() => navigate('home')} className="flex items-center gap-1.5 text-white/70 hover:text-white transition-colors text-[13px] font-medium">
            <ArrowLeft size={14} />
            Back to site
          </button>
          <Logo variant="white" />
      ...
      <div className="flex-1 flex flex-col min-h-screen bg-white">
        ...
        <div className="lg:hidden flex items-center justify-between px-6 py-4 border-b border-border">
          <button onClick={() => navigate('home')} className="flex items-center gap-1.5 text-ink-muted hover:text-ink transition-colors text-[13px] font-medium">
            <ArrowLeft size={14} />
            Back
          </button>
          <Logo />
