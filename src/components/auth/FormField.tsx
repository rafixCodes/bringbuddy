...
export function FormField({ label, error, success, hint, rightSlot, className = '', id, ...rest }: FormFieldProps) {
...
export function PasswordField({ label = 'Password', ...rest }: Omit<FormFieldProps, 'type'>) {
